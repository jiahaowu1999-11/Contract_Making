...
//        htmlStringToPdf();
    ...
    private static void htmlStringToPdf() throws Exception {
        ...
        fontResolver.addFont("D:\\codes\\fonts\\simsun.ttc", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
//        fontResolver.addFont("D:\\codes\\fonts\\huawenlishu.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
        String outFile = "D:/test2_3.pdf";
        File file = new File(outFile);
        if (file.exists()) {
            boolean f = file.delete();
        }
        OutputStream os = new FileOutputStream(outFile);
        String htmlstr = "<body style=\"font-family: SimSun\">" + " <p>    </p><div><div style=\"font-family: C39HrP60DhTt;font-size: 60px;POSITION: absolute; LEFT: 500px;  TOP: 80px;display:none;\"></div><div>\n" +
